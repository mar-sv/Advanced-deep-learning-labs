...
class QNetwork(nn.Module):
    def __init__(self, env):
        ...
        input_channels = env.observation_space.shape[1]
...
if __name__ == "__main__":
    ...
    if params.save_model:
        ...
        model_path = f"/home/convergent/PycharmProjects/Labs D7047E/Lab 4/ex4/ex6 (2)/runs/{run_name}/{params.exp_name}_model.pth"
